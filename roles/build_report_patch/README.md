...
Must register dnf results as patchingresultdnf. Set Windows patching results to patchresult variable. Set var sendemailreport to false if not also sending the report via e-mail
